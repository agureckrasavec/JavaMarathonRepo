...
public class BattleShipGame {
    ...
    public static void doubleDeckShip(GameField gameField) {
        rd = new BufferedReader(new InputStreamReader(System.in));
            ...
            try {
                ...
                if (gameField.isCellFree(Integer.parseInt(arr[0]), Integer.parseInt(arr[1])) &&
                    ...
                    if (gameField.isValidShip(Integer.parseInt(arr[0]), Integer.parseInt(arr[1]), Integer.parseInt(arr[2]), Integer.parseInt(arr[3]))) {
                        gameField.cellLoad(Integer.parseInt(arr[0]), Integer.parseInt(arr[1]), Integer.parseInt(arr[2]), Integer.parseInt(arr[3]));
                        gameField.showGameField();
                        counter++;
                    }else
            ...
            try {
                ...
                if (gameField.isCellFree(Integer.parseInt(arr[0]), Integer.parseInt(arr[1])) &&
                    ...
                    if (gameField.isValidShip(Integer.parseInt(arr[0]), Integer.parseInt(arr[1]), Integer.parseInt(arr[2]), Integer.parseInt(arr[3]),
                        ...
                        gameField.cellLoad(Integer.parseInt(arr[0]), Integer.parseInt(arr[1]), Integer.parseInt(arr[2]),
    ...
    public static void fire(GameField gameField){
        while (true) {
            ...
            if (!gameField.isHit(Integer.parseInt(arr[0]), Integer.parseInt(arr[1]))) {
                break;
            }
    ...
    public static void startGame() {
        ...
        if (randomInt == 1) {
            fire(gameField);
            while (gameField.getShipCount() != 0 || gameField1.getShipCount() != 0) {
                fire(gameField1);
                fire(gameField);
            }
        }
        ...
        if (gameField1.getShipCount() == 0) {
            System.out.println("Игрок №2 выиграл!!!");
        }
        else if (gameField.getShipCount() == 0) {
